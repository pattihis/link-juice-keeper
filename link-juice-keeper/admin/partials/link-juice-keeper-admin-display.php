	  ...
	  <table class="form-table">
		<tbody>
		  ...
		  <tr id="custom_post" <?php echo ( $options['redirect_to'] !== 'post' ) ? $hide : ''; ?>>
			...
			<td>
			  <?php
				$plugin_admin->wp_dropdown_posts(
					array(
						'selected'    => $options['redirect_post'],
		  ...
		  <tr id="custom_url" <?php echo ( $options['redirect_to'] !== 'link' ) ? $hide : ''; ?>>
			...
			<td>
			  <input type="url" placeholder="<?php echo home_url(); ?>" name="ljk_main_settings[redirect_link]" value="<?php echo esc_url_raw(sanitize_text_field($options['redirect_link'])); ?>" style="width: 100%;">
		  ...
		  <tr>
			...
			<td>
			  ...
			  <input type="email" placeholder="<?php echo get_option( 'admin_email' ); ?>" name="ljk_main_settings[notify_to]" value="<?php echo esc_html(sanitize_text_field($notify_address)); ?>" style="width:100%;">
